...
wget -q --no-check-certificate -O ZED_SDK_Linux.run wget -q --no-check-certificate -O ZED_SDK_Linux.run https://download.stereolabs.com/zedsdk/4.1/l4t36.3/jetsons
